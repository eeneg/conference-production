...
<template>
    ...
    <div class="py-5">
        ...
        <Modal :show="showPollModal" :maxWidth="'2xl'">
            <div class="p-6">
                ...
                <div class="mt-3 mb-3 mr-3 pr-6 pl-5">
                    ...
                    <div class="border rounded flex mb-2 px-2" v-for="poll in polls">
                        ...
                        <div class="flex items-center justify-center grow p-2 text-red-900" :class="{'text-green-900':poll.concluded}">
                            {{ poll.concluded == false ? 'Unconcluded' : 'Concluded' }}
                        </div>
                        <div class="flex items-center justify-center float-right p-2">
                            <button @click="openVotingPollModal(poll.title, poll.details)">
