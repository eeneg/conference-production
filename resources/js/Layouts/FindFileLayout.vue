    ...
    <AuthenticatedLayout>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 flex md:flex-row sm:flex-col min-[300px]:flex-col">
            ...
            <div class="md:basis-1/5 py-5">
                <ul class="space-y-2">
                    <li class="">
                        <button @click="changeType('attachment.index')" class="border-l-4 pl-4 pt-1 pb-1 border-transparent w-full text-left" :class="{'border-l-4 w-full border-indigo-500 bg-slate-200 border-l-indigo-500' : props.type == 1}">
                            Attachments
                        </button>
                    </li>
                    <li class="">
